...
<html lang="en">
  <head>
    ...
    <title>United Finance Asia Loans</title>
    <!-- Favicon -->
    ...
    <nav class="navbar navbar-default" role="navigation">  
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- LOGO -->              
          <!-- TEXT BASED LOGO -->
          <a class="navbar-brand" href="index.php">United Finance Asia</a>              
          <!-- IMG BASED LOGO  -->
                ...
                <li><a href="home-loan.php">Home Loan</a></li>  
                 <li><a href="property-loan.php">Property Loan</a></li> 
                  <li><a href="business-loan.php">Business Loan</a></li> 
                    <li><a href="study-loan.php">Education Loan</a></li>                  
